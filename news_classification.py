...
class BertClassifier(nn.Module):
    ...
    def forward(self, input_id, mask):
        ...
        _, pooled_output = self.bert(input_ids= input_id, attention_mask=mask,return_dict=False)  #pooled_output will have CLS output
...
def train(model, train_data, val_data, learning_rate, epochs):
    ...
    # Here using CPU as not much available of GPU
